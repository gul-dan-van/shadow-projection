...
from src.composition.shadow_generation.network.detectron2.structures import BoxMode
from src.composition.shadow_generation.network.detectron2.utils.logger import setup_logger
from src.composition.shadow_generation.network.detectron2.utils.comm import get_world_size
...
if __name__ == "__main__":
    ...
    from src.composition.shadow_generation.network.detectron2.data.catalog import Metadata
    from src.composition.shadow_generation.network.detectron2.utils.visualizer import Visualizer
    from cityscapesscripts.helpers.labels import labels
