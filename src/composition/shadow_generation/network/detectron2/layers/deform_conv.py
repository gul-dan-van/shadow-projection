...
from src.composition.shadow_generation.network.detectron2.utils.develop import create_dummy_class, create_dummy_func
...
try:
    from src.composition.shadow_generation.network.detectron2 import _C
except ImportError:
