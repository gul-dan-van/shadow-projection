...
from src.composition.shadow_generation.network.detectron2.layers.roi_align import ROIAlign
from src.composition.shadow_generation.network.detectron2.utils.memory import retry_if_cuda_oom
...
class ROIMasks:
    ...
    def to_bitmasks(self, boxes: torch.Tensor, height, width, threshold=0.5):
        ...
        """
        from src.composition.shadow_generation.network.detectron2.layers.mask_ops import paste_masks_in_image, _paste_masks_tensor_shape
