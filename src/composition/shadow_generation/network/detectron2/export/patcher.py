...
from src.composition.shadow_generation.network.detectron2.modeling.roi_heads import roi_heads
from src.composition.shadow_generation.network.detectron2.modeling.roi_heads.fast_rcnn import FastRCNNOutputs
