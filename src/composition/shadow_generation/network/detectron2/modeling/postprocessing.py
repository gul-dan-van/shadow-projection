...
from src.composition.shadow_generation.network.detectron2.layers import paste_masks_in_image
from src.composition.shadow_generation.network.detectron2.structures import Boxes, BoxMode, Instances
