...
from src.composition.shadow_generation.network.detectron2.layers import ShapeSpec
from src.composition.shadow_generation.network.detectron2.structures import Boxes, Instances, RotatedBoxes, pairwise_iou, pairwise_iou_rotated
from src.composition.shadow_generation.network.detectron2.utils.events import get_event_storage
from src.composition.shadow_generation.network.detectron2.utils.registry import Registry

from src.composition.shadow_generation.network.detectron2.modeling.matcher import Matcher
from src.composition.shadow_generation.network.detectron2.modeling.poolers import ROIPooler
from src.composition.shadow_generation.network.detectron2.modeling import ROI_HEADS_REGISTRY, StandardROIHeads
from src.composition.shadow_generation.network.detectron2.modeling.roi_heads.roi_heads import Res5ROIHeads
from src.composition.shadow_generation.network.detectron2.modeling.roi_heads.box_head import build_box_head
from src.composition.shadow_generation.network.detectron2.modeling.box_regression import Box2BoxTransform
from src.composition.shadow_generation.network.detectron2.modeling.roi_heads.fast_rcnn import FastRCNNOutputLayers, FastRCNNOutputs, fast_rcnn_inference,LightdirectionOutputLayer
from src.composition.shadow_generation.network.detectron2.modeling.proposal_generator.proposal_utils import add_ground_truth_to_proposals
from src.composition.shadow_generation.network.detectron2.modeling.sampling import subsample_labels
import numpy as np
