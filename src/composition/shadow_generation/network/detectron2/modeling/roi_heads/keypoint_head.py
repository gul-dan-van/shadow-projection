...
from src.composition.shadow_generation.network.detectron2.layers import Conv2d, ConvTranspose2d, ShapeSpec, cat, interpolate
from src.composition.shadow_generation.network.detectron2.structures import heatmaps_to_keypoints
