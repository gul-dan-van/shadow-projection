...
from src.composition.shadow_generation.network.detectron2.layers import ShapeSpec, batched_nms_rotated
from src.composition.shadow_generation.network.detectron2.structures import Instances, RotatedBoxes, pairwise_iou_rotated
