...
from src.composition.shadow_generation.network.detectron2.layers import ShapeSpec, batched_nms, cat
from src.composition.shadow_generation.network.detectron2.structures import Boxes, ImageList, Instances, pairwise_iou
