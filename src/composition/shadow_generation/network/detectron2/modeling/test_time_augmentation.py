...
from src.composition.shadow_generation.network.detectron2.data.transforms import ResizeShortestEdge
from src.composition.shadow_generation.network.detectron2.structures import Instances
