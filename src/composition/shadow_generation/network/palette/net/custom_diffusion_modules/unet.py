...
from .unetblocks import UNetMidBlock2D,UNetMidBlock2DCrossAttn, get_down_block, get_up_block
...
class UNet(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def __init__(
        ...
        up_block_types: Tuple[str] = ("CrossAttnUpBlock2D", "CrossAttnUpBlock2D", "UpBlock2D", "UpBlock2D"),
        ...
        if encoder_hid_dim_type == "image_proj":
            # Kandinsky 2.2
    ...
    def forward(
        ...
        if self.config.addition_embed_type == "image":
            # Kandinsky 2.2 - style
        ...
        if self.encoder_hid_proj is not None and self.config.encoder_hid_dim_type == "image_proj":
            # Kandinsky 2.2 - style
            if "image_embeds" not in added_cond_kwargs:
                raise ValueError(
